...
| [`demos/puter-txt2speech/`](./demos/puter-txt2speech) | HTML (puter.js) |  | Speaks with a Simba 3.2 voice via Puter's built-in Speechify provider in puter.ai.txt2speech() — no API key, no backend, one static page. |
<!-- DEMOS:END -->
