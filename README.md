...
| [`livekit-voice-agent-python/`](./livekit-voice-agent-python) | Python (LiveKit) | Legacy Speechify-owned LiveKit TTS demo, with Deepgram STT and an OpenAI LLM in a LiveKit `AgentSession`. Prefer the official LiveKit plugin demo above for new work. |
